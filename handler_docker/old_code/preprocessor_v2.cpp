// Credit: https://github.com/edenhill/librdkafka/blob/master/examples/rdkafka_example.cpp
#include <iostream>
#include <string>
#include <cstdlib>
#include <cstdio>
...
int main(int argc, char **argv) {
  ...
  // Create configuration objects for global (consumer) and topic
  ...
  // This section prints out the config info
  // if (do_conf_dump) {
  //   int pass;
...
/usr/bin/clang++ -O3 -Wall preprocessor_v2.cpp -std=c++11 -lrdkafka++ -lpthread -lz -lstdc++ -o preprocessor_v2

Command:
./preprocessor_v2 -C -t raw -p 0 -o end
-C     ... consumer
-t raw ... topic "raw"
-p 0   ... partition 0
-o end ... offset end (read most recent messages)

for -o,
"end" ignores messages that were in the queue before the consumer starts up
"beginning" takes messages from the beginning of time, which weren't deleted for some reason
"stored"
default
*/